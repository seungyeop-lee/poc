...
func (s service) FindByID(id uint, tx datasource.Tx) (*Delivery, error) {
	return s.repo.FindById(id, tx)
}

func (s service) Save(input Delivery, tx datasource.Tx) (uint, error) {
...
func (s service) Update(input Delivery, tx datasource.Tx) error {
...
func (s service) Delete(input Delivery, tx datasource.Tx) error {
